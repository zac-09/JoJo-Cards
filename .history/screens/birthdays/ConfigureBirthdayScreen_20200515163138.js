        ...
        {modal && (
          <View style={styles.modal}>
            <TouchableOpacity style={styles.icons}>
              <Text style={{ ...styles.text, fontFamily: "open-sans-bold",paddingRight:10,paddingBottom:5 }}>edit</Text>
              <MaterialIcons name="edit" size={20} color="#fff" onPress={()=>{
                props.navigation.navigation({routeName:"AddNewBirthday"})
              }} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.icons}>
              <Text style={{ ...styles.text, fontFamily: "open-sans-bold",paddingRight:10 }}>delete</Text>
