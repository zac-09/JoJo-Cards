    ...
    <View style={styles.screen}>
      {modal && (
        <View style={styles.modal}>
          <TouchableOpacity><Text>edit</Text>edit</TouchableOpacity>
          <TouchableOpacity><Text>delte</Text>edit</TouchableOpacity>
...
ConfigureBirthdayScreen.navigationOptions = (navData) => {
  const modal = navData.navigation.getParams("modal");
  return {
    headerTitle: (
