  ...
  return (
        ...
        {modal && (
          <View style={styles.modal}>
            <TouchableOpacity style="icons">
              <Text style={{ ...styles.text, fontFamily: "open-sans-bold",padding:10 }}>edit</Text>
              <MaterialIcons name="edit" size={24} color="black" />
            </TouchableOpacity>
            <TouchableOpacity>
              <Text style={{ ...styles.text, fontFamily: "open-sans-bold" }}>delete</Text>
            </TouchableOpacity>
          </View>
        )}
