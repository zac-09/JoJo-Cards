...
const ConfigureBirthdayScreen = (props) => {
	...
	const deleteHandler = (id) => {
		Alert.alert('Are you sure?', 'Do you really want to delete this birthday?', [
		...
		<ScrollView>
			<View style={styles.screen}>
				...
				<View style={styles.content}>
					...
					<Text style={{ ...styles.text, fontFamily: 'open-sans-bold' }}>{birthday.name}</Text>
					<Text style={{ ...styles.text, fontFamily: 'open-sans-bold' }}>{birthday.date}</Text>
					<Text style={styles.text}>
						Turns {birthday.age} in {birthday.daysLeft} days
					</Text>
					<Text style={styles.text}>Zodiac Sign: {birthday.zodiac}</Text>
				</View>
